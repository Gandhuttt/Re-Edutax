...
// Lampiran B-2, domestic input invoices (kode transaksi 1/9/10) behind II.C.
...
// real Coretax auto-populates B-2 from e-Faktur with no manual upload UI.
export const spt_ppn_lampiran_b2 = sqliteTable('spt_ppn_lampiran_b2', {
	id: text('id')
		.primaryKey()
