...
<div class="case-page">
	<section class="card">
		<header class="card-header"><h1>Kasus Saya yang Jatuh Tempo</h1></header>
		<div class="card-body">
			<div class="toolbar">
				...
				<button type="button" onclick={() => (filters = {})}>Hapus Filter</button>
			</div>
			...
			<footer class="pagination">
				...
				<select disabled aria-label="Jumlah baris per halaman"><option>50</option></select>
			</footer>
		</div>
	</section>
</div>
...
<style>
	...
	table { width: 100%; min-width: 166rem; border-collapse: collapse; table-layout: fixed; }
	th, td { padding: .5rem 1rem; text-align: left; vertical-align: top; }
	th { width: 12rem; }
	th:nth-child(3), th:nth-child(5), th:nth-child(10) { width: 18rem; }
	th:nth-child(11), th:nth-child(13), th:nth-child(14) { width: 16rem; }
