...
<div class="tw:mb-6">
    <div class="tw:mb-2 tw:flex tw:items-center tw:justify-between">
        <span class="tw:text-sm tw:font-bold">PENGHASILAN NETO DALAM NEGERI LAINNYA</span>
        {#if bisaEdit}
...
{#if modalTerbuka}
    <div class="overlay">
        <div class="modal">
            <header>
                <span class="tw:text-lg">PENGHASILAN NETO DALAM NEGERI LAINNYA</span>
                <button type="button" onclick={() => (modalTerbuka = false)} aria-label="Tutup">&times;</button>
            </header>
            <div class="body">
                <div class="field">
                    <Label for="l3a4b-kode"><span>Kode</span></Label>
                    <Input id="l3a4b-kode" type={"text"} bind:value={draft.kode} />
                </div>
                <div class="field">
                    <Label for="l3a4b-jenis"><span>Jenis Penghasilan *</span></Label>
                    <Select id="l3a4b-jenis" bind:value={draft.jenisPenghasilan}>
                ...
                <div class="field">
                    <Label for="l3a4b-neto"><span>Penghasilan Neto *</span></Label>
                    <Input
                        id="l3a4b-neto"
                        class={"tw:text-end"}
                        type={"text"}
