<script lang="ts">
	...
	import LampiranA1 from '$lib/components/surat-pemberitahuan/rekap/LampiranA1.svelte';
	import LampiranA2 from '$lib/components/surat-pemberitahuan/rekap/LampiranA2.svelte';
	import LampiranB1 from '$lib/components/surat-pemberitahuan/rekap/LampiranB1.svelte';
	import LampiranB2 from '$lib/components/surat-pemberitahuan/rekap/LampiranB2.svelte';
	import LampiranB3 from '$lib/components/surat-pemberitahuan/rekap/LampiranB3.svelte';
	import LampiranC from '$lib/components/surat-pemberitahuan/rekap/LampiranC.svelte';
