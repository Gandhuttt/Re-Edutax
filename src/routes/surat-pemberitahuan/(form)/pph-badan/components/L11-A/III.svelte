        ...
        <Table class={"tw:w-full"}>
            ...
            {#snippet body()}
                <tr class="header tw:bg-(--color-primary) tw:font-bold tw:text-center">
                    ...
                    <td class="tw:w-[15rem]">PLAFON PIUTANG</td>
                    <td class="tw:w-[15rem]">PIUTANG YANG NYATA-NYATA TIDAK DAPAT DITAGIH</td>
                    <td class="tw:w-[20rem]">METODE PEMBEBANAN</td>
                    <td class="tw:w-[20rem]">JENIS DOKUMEN PEMBUKTI</td>
                    <td class="tw:w-[15rem]">SCROLL KEKANAN</td>
                </tr>
                {#if true}
