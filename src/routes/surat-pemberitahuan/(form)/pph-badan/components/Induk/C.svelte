        ...
        {#snippet body()}
                ...
                <td class="tw:w-[10rem]">
                    <div class="tw:flex tw:gap-5">
                        <Label for={getContext("id")} class="tw:flex tw:items-center tw:gap-1">
                            <input type="radio" name="C1a" value={false} bind:group={C1a} defaultChecked>
                            <span>Tidak</span>
                        </Label>
                        <Label for={getContext("id")} class="tw:flex tw:items-center tw:gap-1">
                            <input type="radio" name="C1a" value={true} bind:group={C1a}>
                            <span>Ya</span>
                        </Label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <div class="tw:flex tw:gap-5">
                        ...
                        <Label for={getContext("id")} class="tw:flex tw:items-center tw:gap-1">
                            <input type="radio" name="C1b" value={true} bind:group={C1b} disabled={!C1a}>
                            <span>Ya</span>
                        </Label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="tw:flex tw:gap-5">
                        ...
                        <Label for={getContext("id")} class="tw:flex tw:items-center tw:gap-1">
                            <input type="radio" name="C2" value={true} bind:group={C2}>
                            <span>Ya</span>
                        </Label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="tw:flex tw:gap-5">
                        <Label for={getContext("id")} class="tw:flex tw:items-center tw:gap-1">
                            <input type="radio" name="C3" value={false} bind:group={C3} defaultChecked>
                            <span>Tidak</span>
                        </Label>
                        <Label for={getContext("id")} class="tw:flex tw:items-center tw:gap-1">
                            <input type="radio" name="C3" value={true} bind:group={C3}>
                            <span>Ya</span>
                        </Label>
                    </div>
                </td>
