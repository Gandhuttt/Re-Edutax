<script lang="ts">
    ...
    $effect(() => {currentTab.title = currentTab.tab === "L1-C" ? "REKONSILIASI LAPORAN KEUANGAN - DAGANG" : currentTab.title})
...
<div class="tw:flex tw:flex-col tw:gap-4 {currentTab.tab === "L1-C" ? "" : "tw:hidden"}">
